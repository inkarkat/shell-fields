...
@test "--utc applies to following FORMAT" {
    LC_ALL=C TZ='Europe/Berlin' run -0 fieldNormalizeDate -F $'\t' 1 --utc -1 -- "${BATS_TEST_DIRNAME}/tabbed.txt"
    assert_output - <<'EOF'
Wed Apr 20 00:00:00 CEST 2022	foo	Mon Apr 11 07:48:53 UTC 2022
